...
시퀀스 sequence: 연달아 일어남, 일련의 연속
        자동으로 값을 생성해 줍니다. 정수값을 일정 간격(대부분 1)으로 증가시키면서 생성.
...
START WITH 1001
INCREMENT BY 10;    -- INCREMENT: 증가 (시퀀스와 함께 사용)

-- 시퀀스에서 사용하는 속성
-- '현재' 시퀀스의 값 currval
-- '다음 차례' 시퀀스의 값 nextval
...
-- 유일한 값을 가져야하는 idx PK 칼럼 값을 시퀀스로 주겠습니다.
...
INSERT INTO TBL_CAR_CO2(IDX,CAR,MODEL,VOLUME,WEIGHT,CO2) 
 VALUES (TEST2_SEQ.nextval,'Hundai', 'I30', 1600, 1326, 97);
INSERT INTO TBL_CAR_CO2(IDX,CAR,MODEL,VOLUME,WEIGHT,CO2) 
 VALUES (TEST2_SEQ.nextval,'Opel', 'Astra', 1600, 1330, 97);
