...
CREATE TABLE tbl_score(
    ...
    REFERENCES              -- 참조테이블과 컬럼
        TBL_STUDENT(stuno)  -- ✅create table 현재 명령실행 전에 tbl_student 있어야함
);

-- ✅테이블 삭제 순서: 자식 테이블 -> 부모 테이블
-- DROP TABLE tbl_student;
-- 오류: 참조 관계 부모 테이블 삭제 못함. 
--                  해결방법1) 자식테이블 삭제    2) FK제약조건 삭제(작업 완료 후 복구)

-- 🔥 참조관계 오류 발생하는 사례(무결성 제약 조건 위배)
-- Ora-02291: integrity constraint (C##IDEV.SYS_C007356) violated - parent key not found
INSERT INTO TBL_SCORE VALUES (1,'2022001', '국어', 88, '김길동', '2022_01');------------------------확인해봐 옹아

-- 정상 실행 
INSERT INTO TBL_SCORE VALUES (2,'2023001','국어',88,'김길동','202501');
INSERT INTO TBL_SCORE VALUES (3,'2025003','국어',90,'김길동','202501');
INSERT INTO TBL_SCORE VALUES (4,'2025004','국어',99,'김길동','202501');
INSERT INTO TBL_SCORE VALUES (5,'2023001','수학',84,'최수학','202402');
INSERT INTO TBL_SCORE VALUES (6,'2025003','수학',70,'최수학','202501');
INSERT INTO TBL_SCORE VALUES (7,'2024004','수학',91,'최수학','202402');
INSERT INTO TBL_SCORE VALUES (8,'2025004','영어',90,'박영어','202501');
INSERT INTO TBL_SCORE VALUES (9,'2025005','영어',95,'박영어','202501');
commit;
-- 학번으로 성적 조회하기
SELECT *
FROM TBL_SCORE
